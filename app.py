...
app.layout = html.Div(
    [
        ...
        html.P(
            "Ce projet présente différentes visualisations de données liées au domaine du vin, avec un accent sur la qualité des vins.",
        ...
        html.Details(
            [
                ...
                html.P(
                    "Plusieurs interactions sont possibles selon le type de grahiques :"
                ),
                html.Ul(
                    [
                        html.Li("Zoom (en utilisant la souris directement)"),
                        html.Li(
                            "Tri (en cliquant sur les carré de couleurs disponible à droite des graphes)"
                        ),
                        html.Li(
                            "Détails (en passant son curseur sur un élément du graphe)"
                        ),
                    ]
                ),
            ],
        ...
        html.Details(
            [
                ...
                html.P(
                    "Sachant que 50% des vins sont notés entre 86 et 90 et que la moyenne est de 88.2.",
                    style={"font-family": "Helvetica", "fontSize": 20},
                ),
            ],
            style={"font-family": "Helvetica", "fontSize": 20},
        ...
        html.P(
            "Commençons par une vue d'ensemble des vins dans le monde. Sans surprise, l'Europe et les États-Unis sont les principaux producteurs de vin de qualité.",
            style={"font-family": "Helvetica", "fontSize": 20},
        ),
        dcc.Graph(id="question-1", figure=fig1),  # Utilisation de la figure importée
        html.Br(),
        html.Br(),
        html.P(
            "Est-ce que la quantité de vins produit par un pays impacte la qualité de ces derniers ? La réponse semble être non.",
            style={"font-family": "Helvetica", "fontSize": 20},
        ),
        dcc.Graph(id="question-3", figure=fig3),  # Utilisation de la figure importée
        html.Br(),
        html.Br(),
        html.P(
